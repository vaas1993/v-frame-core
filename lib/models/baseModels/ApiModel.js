  ...
  (0, _createClass2["default"])(ApiModel, [{
    ...
    function getActionRequestParams() {
      ...
      _ObjectHelper["default"].forEach(formConfig, function (value, key) {
        result[key] = _this2[key] === undefined ? null : _this2[key];
      });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                method = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : 'raw';
              ...
              case 13:
                _context4.next = 15;
                return _VFrame["default"].getInstance().get('api').getInstance().setGetParams(this.getActionQueryParams()).setPostParams(this.getActionRequestParams()).setApiName(this.constructor.ActionApi)[method.toLowerCase()]();
