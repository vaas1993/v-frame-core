  ...
  (0, _createClass2["default"])(ApiModel, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _Api["default"].getInstance().setApiName(this.constructor.DetailApi).setGetParams(params).get();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return _Api["default"].getInstance().setGetParams(params).setApiName(this.constructor.ListApi).get();
    ...
    function getActionRequestParams() {
      ...
      _ObjectHelper["default"].forEach(formConfig, function (value, key) {
        result[key] = _this2[key] || undefined;
      });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                validator = new _asyncValidator["default"](this.rules);
                messages = {
                  "default": '验证错误 %s',
                  required: '%s 不能为空',
                  "enum": '%s 取值范围必须是 %s',
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 12:
                _context4.next = 14;
                return _Api["default"].getInstance().setGetParams(this.getActionQueryParams()).setPostParams(this.getActionRequestParams()).setApiName(this.constructor.ActionApi).raw();
