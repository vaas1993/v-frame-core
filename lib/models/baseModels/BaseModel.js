...
var BaseModel = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BaseModel, [{
    ...
    value: function getIsField(field) {
      return ['primaryKey', 'fieldSuffix', 'errors', 'formatConfig', 'rules', 'fieldLabels', 'response'].indexOf(field) === -1 && (Object.prototype.hasOwnProperty.call(this, field) || this.formatConfig[field] || this.fieldLabels[field]);
    }
    /**
     * 返回当前实例所有的属性名列表
     * @returns {array<string>}
