...
var BaseModel = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BaseModel, [{
    ...
    value: function getIsField(field) {
      return ['primaryKey', 'fieldSuffix', 'errors', 'formatConfig', 'rules', 'fieldLabels', 'response', '$unique'].indexOf(field) === -1 && (Object.prototype.hasOwnProperty.call(this, field) || this.formatConfig[field] || this.fieldLabels[field]) && (field.indexOf(this.fieldSuffix) === -1 || this.getIsField(field.replace(this.fieldSuffix, '')));
    }
    /**
     * 返回当前实例所有的属性名列表
     * @returns {array<string>}
